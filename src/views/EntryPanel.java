...
public class EntryPanel extends JPanel {
    ...
    private JPanel createInputPanel() {
        ...
        handicappedCardCheckbox.setEnabled(false); // Initially disabled
    ...
    private JPanel createDisplayPanel() {
        ...
        spotsTableModel = new DefaultTableModel(columns, 0) {
            ...
            public boolean isCellEditable(int row, int column) {
                return column == 0; // Only select column editable
            }
    ...
    private void searchAvailableSpots() {
        ...
        statusLabel.setText("Found " + availableSpots.size() + 
                          " available spots for " + vehicleType.getDisplayName());
    }
